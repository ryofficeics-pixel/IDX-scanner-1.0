...
function generateSignal(stock, marketContext = {}, sessionContext = {}, histories = {}) {
  ...
  const morningDirect = inMorningBuyWindow() && score >= 75 && dq.score >= 75 && indicators.changePct >= 0.8 && indicators.changePct <= 5 && indicators.projectedVolRatio >= 1.8 && indicators.rangePosition >= 0.75 && indicators.liquidityScore >= 60 && risk.level !== 'HIGH' && indicators.lateFadeScore <= 35;
  const afternoonDirect = inAfternoonBuyWindow() && score >= 75 && dq.score >= 75 && indicators.rangePosition >= 0.70 && indicators.projectedVolRatio >= 1.3 && indicators.intradayTrendScore >= 70 && indicators.lateFadeScore <= 35 && risk.level !== 'HIGH';
